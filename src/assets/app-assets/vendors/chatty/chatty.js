var tags = [{
    ...
    tag: "text",
    name: "name",
    "chat-msg": "Hi, I'm Chatty, and I am going to help you enroll with VIVA Virtual Office. <br/> Lets start with your name?",
    validator: function(input) {
    	return input == "Sandeep"
    },
    invalid: "Your name must be Sandeep to continue"
  },
  {
    type: "input",
    tag: "radio",
