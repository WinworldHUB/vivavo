...
export default function VOTMMembership(props) {
  ...
  const Header = () => {
    return <h3>VOTM Membership Details</h3>;
  };
  ...
  const PlaceVOTMOrderBody = () => {
    return (
      <div className="d-flex justify-content-between">
        <h5 className="pt-1">Place VOTM order to become a VOTM member</h5>
  ...
  return (
    <PageLayout activeSideMenu="0" pageTitle="VOTM Membership">
